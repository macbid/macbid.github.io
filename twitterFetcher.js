  ...
  return {
    ...
    callback: function(data) {
      ...
      while(n > x) {
        ...
        op += '<input type="hidden" name="id" value="'+ tids[n] +'">';
        
        if (showInteractionLinks) {
          op += '<div class="interact"><a href="https://twitter.com/intent/' +
              'tweet?in_reply_to=' + tids[n] + '" target="_blank" class="twitter_reply_icon">' +
              '<span class="icon"></span><span class="text">Répondre</span></a><a href="https://twitter.com/intent/retweet?tweet_id=' +
              tids[n] + '" target="_blank" class="twitter_retweet_icon"><span class="icon"></span><span class="text">Retweet</span></a>' +
              '<a href="https://twitter.com/intent/favorite?tweet_id=' +
              tids[n] + '" target="_blank" class="twitter_fav_icon"><span class="icon"></span><span class="text">Favori</span></a></div>';
        }
        if (parseLinks) {
          if (printUser) {
